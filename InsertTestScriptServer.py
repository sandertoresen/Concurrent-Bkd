...
programs = {
    # "program16x64": [1, 2, 3, 4, 5, 6, 7],
    # "program4x64": [1, 2, 3, 4, 5, 6, 7],
    # "program64x64": [1, 2, 3, 4, 5, 6, 7],
    "program16x128": [1, 2, 4, 8, 16, 32, 64, 128],
    "program4x128": [1, 2, 4, 8, 16, 32, 64, 128],
    "program64x128": [1, 2, 4, 8, 16, 32, 64, 128]
}
